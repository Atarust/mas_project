...
public class TaxiRenderer extends AbstractCanvasRenderer {
  ...
  public void renderDynamic(GC gc, ViewPort vp, long time) {
    final Set<TaxiImplDetails> taxis = roadModel.getObjectsOfType(TaxiImplDetails.class);
    synchronized (taxis) {
      for (final TaxiImplDetails t : taxis) {
  ...
  static Builder builder(Language l) {
    return null;//new AutoValue_TaxiRenderer_Builder(l);
  }
